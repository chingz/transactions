...
describe.only("matchTransactions()", () => {
    let promise;
    let output;
    ...
    describe("output", () => {
        it("contains 5 matching transactions", () => {
            expect(output["matched"]).toHaveLength(6);
        });

        it("contains 2 mis-matching transactions", () => {
        ...
        it("identifies matched, mis-matched and missing transactions", () => {
            expect(output).toEqual({
                matched: [1000101, 1000105, 1000106, 1000107, 1000108, 1000109],
                mismatched: [1000102, 1000103, 1000104, 1000111],
                missing: [1000100, 1000110],
            });
        });
    });
});
